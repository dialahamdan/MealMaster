    ...
    <>
      <div className="videoSection">
        <div className="videoSectionTitle">
          <h1>Explore the Art, Joy, and Passion of Cooking Together</h1>
        </div>

        <div className="videoSectionBody">
          <div className="videoSectionInfo">
            <p>
              Welcome to MealMaster, your go-to destination for culinary
              inspiration. We bring you a mix of timeless recipes and modern
              techniques, making cooking accessible and enjoyable for everyone.
            </p>

            <p>
              At MealMaster, cooking is about more than just food—it's about
              creating memories. From classic dishes to innovative creations,
              we’re here to help you make every meal special. Join us and
              discover the joy of cooking with heart and soul.
            </p>
            ...
            <div>
              <div className="drawer">
                <div className="box">
                  <a
                    href="https://twitter.com/Nour_ASoud"
                  ...
                  <a
                    href="https://github.com/nourabusoud"
                  ...
                  <a
                    href="https://www.nourabusoud.com"
          ...
          <div className="videoSectionVideo">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/PKQHs7DuweM?si=5bqGv-HR-T8F1DW4"
